	...
	return (
		<div className="w-full font-sans px-6 md:px-10" ref={containerRef}>
			<div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
				<h2 className="text-4xl md:text-6xl mb-4 text-foreground max-w-4xl">
					Previous Client Projects
				</h2>
				<p className="text-muted-foreground text-base md:text-lg max-w-md">
					We've curated a timeline of some of our favorite projects from the
					past few years. Take a look at the evolution of our work and the
